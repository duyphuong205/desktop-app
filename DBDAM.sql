...
END
GO 
--REPORT :TENCHUYENDE-SOHOCVIEN-THAPNHAT-CAONHAT-TRUNGBINH 
CREATE PROC sp_thongkediem
AS
BEGIN
  SELECT TENCD AS ChuyenDe,
  COUNT(MAHV) as SoHocVien,
...
END
GO
--TENCHUYENDE - SOKHOAHOC - SOHOCVIEN - DAONHTHU - THAPNHAT - CAONHAT - TRUNGBINH
